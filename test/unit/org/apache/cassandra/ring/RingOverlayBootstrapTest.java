...
public class RingOverlayBootstrapTest extends AbstractRingOverlayTest
{
    ...
    static final UUID NODE_F = UUIDGen.getTimeUUID();
    ...
    public RingOverlayBootstrapTest(Boolean legacy)
    {
        this.legacy = legacy;
    }
    ...
    public void testGetWriteReplicas_1dc_1rack_5nodes_rf3()
    {
        ...
        // | B: [33, 231, 429, 627, 825] | E:  [132, 330, 528, 726, 924]
        // | C: [66, 264, 462, 660, 858] | F*: [165, 363, 561, 759, 957] (will join later)
        TestCluster cluster = TestCluster.builder()
                                         .withReplicationFactor(3)
                                         .withNode(NODE_A).withManualTokens(0L, 198L, 396L, 594L, 792L)
                                         .withNode(NODE_B).withManualTokens(33L, 231L, 429L, 627L, 825L)
                                         .withNode(NODE_C).withManualTokens(66L, 264L, 462L, 660L, 858L)
                                         .withNode(NODE_D).withManualTokens(99L, 297L, 495L, 693L, 891L)
                                         .withNode(NODE_E).withManualTokens(132L, 330L, 528L, 726L, 924L)
                                         .build(legacy);
