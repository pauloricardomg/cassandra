...
public class NetworkTopologyStrategyAdapter implements RingOverlay
{
    private final TokenMetadata tokenMetadata;
    private final NetworkTopologyStrategy nts;

    public NetworkTopologyStrategyAdapter(TokenMetadata tokenMetadata, NetworkTopologyStrategy nts)
    {
