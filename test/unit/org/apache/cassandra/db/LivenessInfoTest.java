...
public class LivenessInfoTest
{
    ...
    public void testSupersedes()
    {
        ...
        first = LivenessInfo.create(100, 0, nowInSeconds);
        second = LivenessInfo.withExpirationTime(99, LivenessInfo.MV_EXPIRED_TTL, nowInSeconds);
        assertSupersedes(first, second);
        ...
        first = LivenessInfo.withExpirationTime(100, LivenessInfo.MV_EXPIRED_TTL, nowInSeconds);
        ...
        first = LivenessInfo.withExpirationTime(100, LivenessInfo.MV_EXPIRED_TTL, nowInSeconds + 1);
        second = LivenessInfo.withExpirationTime(100, LivenessInfo.MV_EXPIRED_TTL, nowInSeconds);
        assertSupersedes(first, second);
    }
    ...
    public void testIsLive()
    {
        ...
        assertIsLive(LivenessInfo.withExpirationTime(100, LivenessInfo.MV_EXPIRED_TTL, nowInSeconds), nowInSeconds - 3, false);
        assertIsLive(LivenessInfo.withExpirationTime(100, LivenessInfo.MV_EXPIRED_TTL, nowInSeconds), nowInSeconds, false);
        assertIsLive(LivenessInfo.withExpirationTime(100, LivenessInfo.MV_EXPIRED_TTL, nowInSeconds), nowInSeconds + 3, false);
    }
