...
import org.apache.cassandra.db.view.ViewWriteHandler;
...
public class Keyspace
{
                                               ...
                                               boolean updateViews)
    {
        ...
        Optional<List<ViewWriteHandler>> viewWriteFutures = Optional.empty();
            ...
            for (PartitionUpdate upd : mutation.getPartitionUpdates())
            {
                ...
                if (requiresViewUpdate)
                {
                    try
                    {
                        ...
                        ViewWriteHandler viewWriteFuture = viewManager.forTable(upd.metadata().id).pushViewReplicaUpdates(upd);
