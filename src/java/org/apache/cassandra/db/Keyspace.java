...
public class Keyspace
{
    ...
    private final AtomicReference<MultiDatacenterRingOverlay> ringState = new AtomicReference<>();

    public synchronized void onRingChange(RingSnapshot newRing)
    {
        MultiDatacenterRingOverlay newState = replicationStrategy.createReplicatedRing(newRing);
        ringState.set(newState);
    }

    public MultiDatacenterRingOverlay getRingSnapshot()
    {
