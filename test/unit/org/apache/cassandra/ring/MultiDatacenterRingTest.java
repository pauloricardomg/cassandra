...
public class MultiDatacenterRingTest
{
    ...
    @Test
    public void testgetReplicasForTokenWrite_1dc_5nodes_rf3()
    {
        // Node's Tokens
        ...
        assertThat(ring.getReplicasForTokenWrite(token(10L))).isEqualTo(normalReplicas(NODE_A, NODE_C, NODE_B));

        // Token 160: [200:C]--[250:B]--[300:D]
        assertThat(ring.getReplicasForTokenWrite(token(10L))).isEqualTo(normalReplicas(NODE_C, NODE_B, NODE_D));

        // Token 210: [250:B]--[300:D]--[350:C]
        assertThat(ring.getReplicasForTokenWrite(token(10L))).isEqualTo(normalReplicas(NODE_B, NODE_D, NODE_C));

        // Token 260: [300:D]--[350:C]--[400:E]
        assertThat(ring.getReplicasForTokenWrite(token(10L))).isEqualTo(normalReplicas(NODE_D, NODE_C, NODE_E));

        // Token 310: [350:C]--[400:E]--[450:D]
        assertThat(ring.getReplicasForTokenWrite(token(10L))).isEqualTo(normalReplicas(NODE_C, NODE_E, NODE_D));

        // Token 360: [400:E]--[450:D]--[550:E]*--[650:A] (* token [550:E] is skipped because node E already replicates this range)
        assertThat(ring.getReplicasForTokenWrite(token(10L))).isEqualTo(normalReplicas(NODE_E, NODE_D, NODE_A));

        // Token 410: [450:D]--[550:E]--[650:A]
        assertThat(ring.getReplicasForTokenWrite(token(10L))).isEqualTo(normalReplicas(NODE_D, NODE_E, NODE_A));

        // Token 460: [550:E]--[650:A]--[750:B]
        assertThat(ring.getReplicasForTokenWrite(token(10L))).isEqualTo(normalReplicas(NODE_E, NODE_A, NODE_B));

        // Token 560: [650:A]--[750:B]--[850:C]
        assertThat(ring.getReplicasForTokenWrite(token(10L))).isEqualTo(normalReplicas(NODE_A, NODE_B, NODE_C));

        // Token 660: [750:B]--[850:C]--[950:D]
        assertThat(ring.getReplicasForTokenWrite(token(10L))).isEqualTo(normalReplicas(NODE_B, NODE_C, NODE_D));

        // Token 760: [850:C]--[950:D]--[1050:E]
        assertThat(ring.getReplicasForTokenWrite(token(10L))).isEqualTo(normalReplicas(NODE_C, NODE_D, NODE_E));
