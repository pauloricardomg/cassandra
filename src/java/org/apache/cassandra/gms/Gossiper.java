...
public class Gossiper implements IFailureDetectionEventListener, GossiperMBean
{
    ...
    void examineGossiper(List<GossipDigest> gDigestList, List<GossipDigest> deltaGossipDigestList, Map<InetAddressAndPort, EndpointState> deltaEpStateMap)
    {
        ...
        for ( GossipDigest gDigest : gDigestList )
        {
            ...
            */
            if (epStatePtr != null)
            {
                // exclude all "empty" states; only include states from peers or about this instance, not states
                // generated by this instance about other peers.
                // see CASSANDRA-16213
    ...
    public void addSavedEndpoint(InetAddressAndPort ep, UUID hostId, Collection<Token> tokens)
    {
        ...
        else
        {
            ...
            // NOTE: never add STATUS or STATUS_WITH_PORT, adding will cause this state object to be gossiped to other
            // nodes, which is unexpected behavior.
            if (hostId != null)
