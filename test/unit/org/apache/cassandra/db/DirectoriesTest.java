...
public class DirectoriesTest
{
    ...
    public void testSecondaryIndexDirectories()
    {
        ...
        assertEquals(30, SnapshotManager.instance.trueSnapshotsSize(PARENT_CFM, parentDirectories));
        assertEquals(40, SnapshotManager.instance.trueSnapshotsSize(INDEX_CFM, indexDirectories));
