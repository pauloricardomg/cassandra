...
public class CreateSnapshotOptions
{
    ...
    private CreateSnapshotOptions(SnapshotType type, String tag, DurationSpec.IntSecondsBound ttl, Instant creationTime, boolean skipFlush, boolean ephemeral, String[] entities,
                                  RateLimiter rateLimiter, Predicate<SSTableReader> sstableFilter, ColumnFamilyStore cfs)
    {
        this.type = type;
        this.tag = tag;
        this.ttl = ttl;
    ...
    public static CreateSnapshotOptions userSnapshot(String tag, String... entities)
    {
        return userSnapshot(tag, Collections.emptyMap(), entities);
    }

    public static CreateSnapshotOptions userSnapshot(String tag, Map<String, String> options, String... entities)
    {
    ...
    public static class Builder
    {
        ...
        private Predicate<SSTableReader> sstableFilter;
        private SnapshotType type;

        Builder(String tag, SnapshotType type,  Predicate<SSTableReader> sstableFilter, String... entities)
        {
            this.tag = tag;
            this.type = type;
            this.entities = entities;
        ...
        public CreateSnapshotOptions build()
        {
            ...
            return new CreateSnapshotOptions(type, tag, ttl, creationTime, skipFlush, ephemeral, entities, DatabaseDescriptor.getSnapshotRateLimiter(),
                                             sstableFilter, cfs);
        }
    }
}
